...
import {CartState, clearCart, minusCartItem, plusCartItem, removeCartItem} from "../redux/reducers/cart";
// @ts-ignore
import emptyCart from './../assets/img/empty-cart.png'
import {Button} from "../components";

const Cart = React.memo(() => {
    const {totalPrice, totalCount, items} = useSelector<reduxStoreType, CartState>(({cart}) => cart)
